    ...
    <>
      <Slide 
        ...
        listItems={[
          ...
          'WINGS BUSINESS s.r.o. cooperates with leading breeding institutes and stations. The company guarantees the purity of varieties.',
          'The technical equipment of our company allows us to carry out land works of any complexity on our own.',
          'WINGS BUSINESS s.r.o. waiting for you and has the technical capabilities to implement your wildest ideas for landscape design and landscaping.',
